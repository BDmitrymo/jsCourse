window.addEventListener('DOMContentLoaded', function() {
	...
	//поддержка IE
	if (document.documentElement.addEventListener === undefined) { // (1)

	  Object.defineProperty(Element.prototype, 'addEventListener', { // (2)
	    get: function() {
	      var el = this.addEventListener;
	      do {
	        if (el.nodeType === 1) {
	          return el;
	        }
